...
import FourInARow.controller.AdvancedComputerPlayerStrategy;
...
public class TestAdvancedComputerStrategy {
	...
	public final void testMakeMove() {
		...
		AdvancedComputerPlayerStrategy cs = new AdvancedComputerPlayerStrategy(col);
